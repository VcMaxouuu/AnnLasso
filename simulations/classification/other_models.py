...
from compared_models.classification import LNClassifier, XGBoostClassifier, RandomForestClassifier
    ...
    for dataset_folder in dataset_folders:
        ...
        for root, dirs, files in os.walk(dataset_path):
            if 'data.csv' in files and 'training_indices.csv' in files:
                ...
                outdir = os.path.join(root, 'results/lasso_net_v2/results.csv') #other_models
